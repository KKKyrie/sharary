<template>
	<div class="reply-container">
		<span class="reply-btn" title="直接向 TA 发送你想对 TA 说的话" @click.stop="showDialog">
		...
		<div class="reply-dialog" v-if="displayInput">
			<input type="text" class="form-control input-area" placeholder="向 TA 发送你想说的话..." />
			&nbsp;
